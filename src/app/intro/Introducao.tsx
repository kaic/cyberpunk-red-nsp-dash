          ...
          <div className="prose prose-invert prose-green max-w-none">
            ...
            <ul className="space-y-3 text-gray-300 mb-6">
              ...
              <li className="flex items-start">
                <span className="text-green-500 mr-3">•</span>
                <span>
                  Cada distrito tem sua própria identidade e características
                  únicas. De bairros corporativos reluzentes a zonas de
                  ...
                  área conta uma história distinta de desigualdade e desespero.
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-green-500 mr-3">•</span>
                <span>
                  As paredes da cidade são o canvas para manifestações de arte
                  de rua, muitas vezes com mensagens de resistência contra as
                  corporações e o controle estatal. Grafites e murais narram a
                  história do povo, muitas vezes apagados e reescritos conforme
                  o ciclo interminável de protestos e repressão continua.
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-green-500 mr-3">•</span>
                <span>
                  As ruas de Nova São Paulo são um emaranhado complexo, com vias
                  ...
                  drones que patrulham os céus.
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-green-500 mr-3">•</span>
                <span>
                  A cidade está dividida entre ricos e pobres, entre aqueles que
                  se beneficiam das corporações e aqueles que lutam para
                  sobreviver. A polarização política é evidente, manifestando-se
                  em grafites, pichações e cartazes que clamam por justiça e
                  liberdade.
                </span>
              </li>
              <li className="flex items-start">
                <span className="text-green-500 mr-3">•</span>
                <span>
                  Algumas áreas são controladas por gangues impiedosas, enquanto
              ...
              <li className="flex items-start">
                ...
                <span>
                  ...
                  de Nova São Paulo é um espetáculo caótico.
                </span>
              </li>
            </ul>
            ...
            <p className="text-gray-300 mb-6">
              ...
              nos bastidores do poder, a polícia do estado mantém uma ordem
            ...
            <p className="text-gray-300">
              ...
              Well, um talentoso estudante de engenharia psíquica, durante um
